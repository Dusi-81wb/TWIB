...
platform domain: identifiers, email addresses, names, slugs, descriptions,
timestamps, URLs, versions, money, and metadata. Every value object is
immutable, validates its value at construction, and is compared by value.
